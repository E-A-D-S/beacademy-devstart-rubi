      ...
      <table cellspacing="0" cellpadding="0" border="1">
          <tr>
              ...
              <td width="30%">
                  ...
                  <br/>
                  <br/>
                  <p class="content right text" style="font-weight:bold;"></p>
              </td>
          </tr>
          <tr>
              <td width="70%" colspan="6">
                  <span class="title">Nome do Beneficiário / CNPJ / CPF / Endereço: {{ $data['name'] }}</span>
                  <br/>
          ...
          <tr>
              <td colspan="7">
                  <table border="0" style="border:none">
                      <tr>
                          <td width="60%"><span class="text"><b>Nome do Pagador: </b> </span></td>
                          <td><span class="text"><b>CNPJ/CPF: </b> </span></td>
                      </tr>
                      <tr>
                          <td><span class="text"><b>Endereço: </b> ,   - - -  - </span></td>
                          <td>&nbsp;</td>
                      </tr>
                      <tr>
